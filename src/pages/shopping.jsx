                  ...
                  <div className="order_item_list_table">
                    <div className="table-responsive">
                      <table className="table order_table">
                        <tbody>
                          <tr>
                            <td className="order_item_img">
                              <img
                                src="./assets/images/addtocart_image1.png"
                                alt=""
                              />
                            </td>
                            <td className="order_item_name">
                              <h3>Cappuccino</h3>
              ...
              <div className="col-lg-4 col-md-12">
                <div className="">
                  ...
                  <div className="coupon_section mt-4">
                    ...
                    <div className="coupon_section_price">
                      <p className="order_sub_price_name">
                    ...
                    <div className="coupon_section_price total m-0">
                      <p className="order_sub_price_totalname">
                  ...
                  <div className="button_group">
                    <button className="yellow_btn out_line">
                      Continue Shopping
                    </button>
                    <button
