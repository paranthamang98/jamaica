            ...
            <div class="col-lg-8 col-md-12">
                <div class="order_item">
                    ...
                    <div class="order_item_list_table">
                        <div class="table-responsive">
                            <table class="table order_table">
                                <tbody>
                                    <tr>
                                        <td class="order_item_img"><img src="./assets/images/addtocart_image1.png" alt=""/></td>
                                        <td class="order_item_name"><h3>Cappuccino</h3>
                                    ...
                                    <tr>
                                        <td class="order_item_img"><img src="./assets/images/addtocart_image2.png" alt=""/></td>
                                        <td class="order_item_name"><h3>Cheeseburger</h3>
                                          <ul class="order_items_type">
                                            <li>Small</li>
                                            <li>Skimmed</li>
                                          </ul>
                                    ...
                                    <tr>
                                        <td class="order_item_img"><img src="./assets/images/addtocart_image3.png" alt=""/></td>
                                        <td class="order_item_name"><h3>Cobb salad</h3>
                                          <ul class="order_items_type">
                                            <li>Small</li>
                                            <li>Skimmed</li>                                          
                                          </ul>
                    ...
                    <div class="order_sub_title ">
                      <p class="order_sub_title_header">Select Pick Up Details
                      </p>
                    ...
                    <div class="order_sub_title">
                        ...
                        <textarea class="addMessages_text" placeholder="Enter Message"></textarea>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-12">
                <div class="">
                    ...
                    <div class="coupon_section mt-4">
                        ...
                        <div class="coupon_section_price">
                          <p class="order_sub_price_name">Discount <span>(Coupon)</span></p>
                  ...
                  <div class="coupon_section_price total m-0">
                    <p class="order_sub_price_totalname">Amount Payable <span>(inc.GST)</span></p>
                    <p class="order_sub_price_total">₹900.00</p>
                </div>
                    </div>
                    <div class="button_group">
                      <button class="yellow_btn out_line">Continue Shopping</button>
                      <button class="yellow_btn"  type="button"data-bs-toggle="modal" data-bs-target="#payment2">Checkout</button>
